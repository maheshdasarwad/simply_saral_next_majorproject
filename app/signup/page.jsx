  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50 px-4 py-12">
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="hidden lg:block relative h-[700px] rounded-2xl overflow-hidden shadow-2xl">
          <img
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 relative overflow-hidden">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Join Simply Saral and get started today
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start">
                <input
                  ...
                  className="w-4 h-4 mt-1 text-blue-700 border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
                />
